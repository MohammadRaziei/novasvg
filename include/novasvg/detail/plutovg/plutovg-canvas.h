...
{
    plutovg_state_t* state = static_cast<plutovg_state_t*>(malloc(sizeof(plutovg_state_t)));
    state->paint = NULL;
...
{
    plutovg_canvas_t* canvas = static_cast<plutovg_canvas_t*>(malloc(sizeof(plutovg_canvas_t)));
